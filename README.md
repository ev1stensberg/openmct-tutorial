...
[dictionary-plugin.js](dictionary-plugin.js)
```javascript
...
_[dictionary-plugin.js](dictionary-plugin.js)_
```javascript
function DictionaryPlugin() {
...
_Snippet from [dictionary-plugin.js](dictionary-plugin.js)_
```javascript
...
_[historical-telemetry-plugin.js](historical-telemetry-plugin.js)_
```javascript
/**
...
_[realtime-telemetry-plugin.js](realtime-telemetry-plugin.js)_
```javascript
/**
