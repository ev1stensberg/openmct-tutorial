...
_[dictionary-plugin.js](https://github.com/nasa/openmct-tutorial/blob/part-b-step-3/dictionary-plugin.js)_
```javascript
function DictionaryPlugin() {
...
_[dictionary-plugin.js](https://github.com/nasa/openmct-tutorial/blob/part-b-step-4/dictionary-plugin.js)_
```javascript
...
_[dictionary-plugin.js](https://github.com/nasa/openmct-tutorial/blob/part-c/dictionary-plugin.js)_
```javascript
function getDictionary() {
    return http.get('/dictionary.json')
        .then(function (result) {
...
_[historical-telemetry-plugin.js](https://github.com/nasa/openmct-tutorial/blob/part-d/historical-telemetry-plugin.js)_
```javascript
/**
...
_[index.html](https://github.com/nasa/openmct-tutorial/blob/part-d/index.html)_
```html
<!DOCTYPE html>
<html>
<head>
...
_[realtime-telemetry-plugin.js](https://github.com/nasa/openmct-tutorial/blob/master/realtime-telemetry-plugin.js)_
```javascript
/**
...
_[index.html](https://github.com/nasa/openmct-tutorial/blob/master/index.html)_
```html
<!DOCTYPE html>
<html>
<head>
